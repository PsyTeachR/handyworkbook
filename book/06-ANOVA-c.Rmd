...
$$df_{within} = ((5 \times 3)-1) - (5-1) - (3-1) = `r (5-1)*(3-1)`$$
...
$$df_{within} = (N-1)(k-1) = (5 - 1) \times (3 - 1) = `r 5-1` \times `r 3-1` = `r (5-1)*(3-1)`$$
...
Next we see that we have a total number of participants of $N$ = `r Ngroup1`. And if we put that into the formula for the $df_{Within}$ we see:

$$df_{Within} = (N-1)\times(k-1) = (`r Ngroup1` - 1)\times(`r Ngroups` - 1) = `r (Ngroup1 - 1)*(Ngroups - 1)`$$
