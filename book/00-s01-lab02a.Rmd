...
options1 <- c(answer = mode1, wrong1[1], wrong1[2], wrong1[3])
options2 <- c(answer = mode2, wrong2[1], wrong2[2], wrong2[3])
options3 <- c(answer = mode3, wrong3[1], wrong3[2], wrong3[3])
options4 <- c(answer = mode4, wrong4[1], wrong4[2], wrong4[3])
options5 <- c(answer = mode5, wrong5[1], wrong5[2], wrong5[3])
