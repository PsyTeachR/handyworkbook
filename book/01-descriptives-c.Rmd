...
uci2 <- sample(c(answer = m2 + sem1 * zci, m1 - sem1 * zci, m4 + sem1 * zci, m3 - sem1 * zci))
lci2 <- sample(c(answer = m2 - sem1 * zci, m1 + sem1 * zci, m4 + sem1 * zci, m3 - sem1 * zci))
uci3 <- sample(c(answer = m3 + sem1 * zci, m1 - sem1 * zci, m2 + sem1 * zci, m5 - sem1 * zci))
lci3 <- sample(c(answer = m3 - sem1 * zci, m1 + sem1 * zci, m2 + sem1 * zci, m5 - sem1 * zci))
uci4 <- sample(c(answer = m4 + sem1 * zci, m5 - sem1 * zci, m2 + sem1 * zci, m3 - sem1 * zci))
lci4 <- sample(c(answer = m4 - sem1 * zci, m5 + sem1 * zci, m2 + sem1 * zci, m3 - sem1 * zci))
uci5 <- sample(c(answer = m5 + sem1 * zci, m4 - sem1 * zci, m1 + sem1 * zci, m3 - sem1 * zci))
lci5 <- sample(c(answer = m5 - sem1 * zci, m4 + sem1 * zci, m1 + sem1 * zci, m3 - sem1 * zci))
