...
$$\bar{x} = \frac{50.8 + 63.5 +  45.7  + 25.4  + 29.2  + 49.5  + 38.1  + 30.5  + 35.6  + 58.4}{10}$$

Which reduces to:

$$\bar{x} = \frac{426.7}{10} = 42.67$$

And if we repeat the same procedure for y (i.e. IQ), we get:

$$\bar{y} = \frac{107 + 121 +  106  + 72  + 85  + 105  + 93  + 88  + 97  + 123}{10}$$

Which reduces to:

$$\bar{y} = \frac{997}{10} = 99.7$$
...
* The mean of x is $\bar{x} = 42.67$
* The mean of y is $\bar{y} = 99.7$
...
P~1~ = $(x_i - \bar{x})(y_i - \bar{y}) = (50.8 - 42.67)\times(107 - 99.7) = (8.13)\times(7.3) = 59.349$

and we can do that for all participants which would look like:

* P~2~ = $(x_i - \bar{x})(y_i - \bar{y}) = (63.5 - 42.67)\times(121 - 99.7) = 20.83\times21.3 = 443.679$
* P~3~ = $(x_i - \bar{x})(y_i - \bar{y}) = (45.7 - 42.67)\times(106 - 99.7) = 3.03\times6.3 = 19.089$
* P~4~ = $(x_i - \bar{x})(y_i - \bar{y}) = (25.4 - 42.67)\times(72 - 99.7) = -17.27\times-27.7 = 478.379$
* P~5~ = $(x_i - \bar{x})(y_i - \bar{y}) = (29.2 - 42.67)\times(85 - 99.7) = -13.47\times-14.7 = 198.009$
* P~6~ = $(x_i - \bar{x})(y_i - \bar{y}) = (49.5 - 42.67)\times(105 - 99.7) = 6.83\times5.3 = 36.199$
* P~7~ = $(x_i - \bar{x})(y_i - \bar{y}) = (38.1 - 42.67)\times(93 - 99.7) = -4.57\times-6.7 = 30.619$
* P~8~ = $(x_i - \bar{x})(y_i - \bar{y}) = (30.5 - 42.67)\times(88 - 99.7) = -12.17\times-11.7 = 142.389$
* P~9~ = $(x_i - \bar{x})(y_i - \bar{y}) = (35.6 - 42.67)\times(97 - 99.7) = -7.07\times-2.7 = 19.089$
* P~10~ = $(x_i - \bar{x})(y_i - \bar{y}) = (58.4 - 42.67)\times(123 - 99.7) = 15.73\times23.3 = 366.509$
...
Meaning that we would have a correlation value of, to three decimal places, $r$ = 0.967, which, following Cohen's (1988) proposed cut-offs shown below, would be considered a strong positive relationship.
