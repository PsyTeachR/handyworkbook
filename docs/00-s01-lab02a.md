...
<p></p>
1. What is the mode of DataSet 1? <select class='webex-solveme' data-answer='["3"]'> <option></option> <option>3</option> <option>5</option> <option>4</option> <option>1</option></select>
2. What is the mode of DataSet 2? <select class='webex-solveme' data-answer='["10"]'> <option></option> <option>10</option> <option>7</option> <option>8</option> <option>6</option></select>
3. What is the mode of DataSet 3? <select class='webex-solveme' data-answer='["18"]'> <option></option> <option>18</option> <option>17</option> <option>39</option> <option>15</option></select>
4. What is the mode of DataSet 4? <select class='webex-solveme' data-answer='["14"]'> <option></option> <option>14</option> <option>20</option> <option>10</option> <option>12</option></select>
5. What is the mode of DataSet 5? <select class='webex-solveme' data-answer='["6"]'> <option></option> <option>6</option> <option>3</option> <option>4</option> <option>2</option></select>
