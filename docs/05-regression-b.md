...
* To two decimal places, what would be the predicted value of IQ if the HeadSize was 37.8? <div class='webex-radiogroup' id='radio_IGJVEAOBFP'><label><input type="radio" autocomplete="off" name="radio_IGJVEAOBFP" value=""></input> <span>119.67</span></label><label><input type="radio" autocomplete="off" name="radio_IGJVEAOBFP" value="answer"></input> <span>93.88</span></label><label><input type="radio" autocomplete="off" name="radio_IGJVEAOBFP" value=""></input> <span>120.51</span></label></div>
...
* To two decimal places, what would be the predicted value of IQ if the HeadSize was 24.2? <div class='webex-radiogroup' id='radio_FJLHRWFZQN'><label><input type="radio" autocomplete="off" name="radio_FJLHRWFZQN" value=""></input> <span>119.67</span></label><label><input type="radio" autocomplete="off" name="radio_FJLHRWFZQN" value="answer"></input> <span>93.88</span></label><label><input type="radio" autocomplete="off" name="radio_FJLHRWFZQN" value=""></input> <span>77.64</span></label></div>
...
* To two decimal places, what would be the predicted value of IQ if the HeadSize was 52.9? <div class='webex-radiogroup' id='radio_OZBMRHEPSV'><label><input type="radio" autocomplete="off" name="radio_OZBMRHEPSV" value=""></input> <span>111.91</span></label><label><input type="radio" autocomplete="off" name="radio_OZBMRHEPSV" value="answer"></input> <span>120.51</span></label><label><input type="radio" autocomplete="off" name="radio_OZBMRHEPSV" value=""></input> <span>119.67</span></label></div>
...
* To two decimal places, what would be the predicted value of IQ if the HeadSize was 48.4? <div class='webex-radiogroup' id='radio_OUWIXLCVVL'><label><input type="radio" autocomplete="off" name="radio_OUWIXLCVVL" value=""></input> <span>77.64</span></label><label><input type="radio" autocomplete="off" name="radio_OUWIXLCVVL" value=""></input> <span>119.67</span></label><label><input type="radio" autocomplete="off" name="radio_OUWIXLCVVL" value="answer"></input> <span>106.54</span></label></div>
